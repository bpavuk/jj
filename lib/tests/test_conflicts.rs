...
fn test_materialize_conflict_with_labels() {
    ...
    let conflict_labels = ConflictLabels::from_vec(vec![
        "commit 1 conflict label".into(),
        "commit 2 conflict label".into(),
        "commit 3 conflict label".into(),
    ]);
    insta::assert_snapshot!(
        ...
        @r"
    <<<<<<< conflict 1 of 1
    %%%%%%% diff from: commit 2 conflict label
    \\\\\\\        to: commit 1 conflict label
    -base 1
    +side 1
    +++++++ commit 3 conflict label
    side 2
    >>>>>>> conflict 1 of 1 ends
    "
    );
    ...
    insta::assert_snapshot!(
        ...
        @r"
    <<<<<<< conflict 1 of 1
    +++++++ commit 1 conflict label
    side 1
    ------- commit 2 conflict label
    base 1
    +++++++ commit 3 conflict label
    side 2
    >>>>>>> conflict 1 of 1 ends
